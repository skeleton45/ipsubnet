...
if p == 1:
	...
	a = str(raw_input("\n\033[32;1m[>>>] Masukan IP Adress > "))
	
	if a <= "127.999.999.999":
		print "\n  \033[33;1m       	[!] KETEMU GAN [!]"
		print "\n\033[39;1m   [>>>] IP Adress: " , a
...
if p == 2:
	...
	print ("   *       *    *    ***")
	print ("\n   \033[33;1m     [x] IP Class & SUBNETMASK Finder Tool [x]")
	print ("\n\033[39;1m[?] Apasih kegunaan tool/alat ini? Alat ini berfungsi untuk mencari 'Class IP & SUBNETMASK' dengan menggunakan alamat IP atau IP Adress.\n\n[!] Contoh IP Adress: \n   [1] 116.22.177.1\n   [2] 192.168.1.12\n   [3] 222.167.22.11")
